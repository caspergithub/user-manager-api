...
// get code from database.php and user.php
...
function createUser(){
  ...
  $userModel->userEmail=$postData->email;
  $userModel->userPassword=$postData->password;
...
function readSIngleUser(){
  ...
  // get the id on the user you want viewed
